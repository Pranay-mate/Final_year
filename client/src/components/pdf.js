...
const PDF = (props) => {
  return (
    <>
      <div className="Post" ref={ref} style={{width: '60em', height: '100em'}}>
<div class="rela-block page">
    ...
    <div class="side-bar">
        ...
        <p>1-800-CALLPLZ</p>
        <p>emailsareforsquares@gmail.com</p><br></br>
    ...
    <Pdf targetRef={ref} filename="post.pdf" style={{'position': 'fixed'}}>
