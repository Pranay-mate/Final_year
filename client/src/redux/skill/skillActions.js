...
export const getSkills = () => async dispatch => {
    ...
    try{
        ...
        const res = await axios.get(`https://sleepy-reaches-43026.herokuapp.com/Final_year/skills/`+userId)
...
export const addSkills = userobj => async dispatch => {
    console.log(userobj)
    try{
        const res = await axios.post(`https://sleepy-reaches-43026.herokuapp.com/Final_year/skills`, userobj)
        dispatch( {
            type: ADD_SKILLS,
            payload: res.data
        })
...
export const updateSkills = data => async dispatch => {
    ...
    console.log(data);
    try{
        const res = await axios.put(`https://sleepy-reaches-43026.herokuapp.com/Final_year/skills/`+userId, data)
        console.log(res)
        dispatch( {
            type: UPDATE_SKILLS,
            payload: res.data
...
export const deleteSkills = data => async dispatch => {
    ...
    //console.log(data)
    try{
        const res = await axios.delete(`https://sleepy-reaches-43026.herokuapp.com/Final_year/skills/`+data)
        dispatch( {
            type: DELETE_SKILLS,
            payload: res.data
        })
